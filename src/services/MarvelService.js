...
const useMarvelService = () => {
    ...
    const _apiKey = 'apikey=c594be2b12b4d62e4994f1e4f7121048';
    const _baseOffset = 210;
    // offsetRandom = Math.floor(Math.random() * (1500));
    ...
    const _tranformCharacter = (char) => {
        return {
            id: char.id,
            name: char.name,
            description: char.description ? `${char.description.slice(0, 210)}...` : 'There is no description yet for this character',
